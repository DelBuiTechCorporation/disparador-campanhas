...
export class TenantController {
  ...
  static async getAllowedProviders(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      if (!tenantId) {
        // Se não há tenant, retornar apenas WAHA (para superadmin sem tenant selecionado)
        return res.json({
          success: true,
          allowedProviders: ['WAHA']
        });
      }
      ...
      res.json({
        success: true,
        allowedProviders: tenant.allowedProviders || ['WAHA']
      });
    } catch (error) {
  ...
  static async createTenant(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      // Validar provedores permitidos (apenas WAHA suportado)
      const validProviders = ['WAHA'];
  ...
  static async updateTenant(req: AuthenticatedRequest, res: Response) {
    try {
      ...
      // Validar provedores permitidos se fornecido (apenas WAHA suportado)
      const validProviders = ['WAHA'];
